...
const MyAccount = ({ navigation }) => {
  ...
  function renderSectionOne() {
    return (
      ...
      >
        <InfoItem label="Full Name" value="Amer Abdulai" />
  ...
  function renderSectionTwo() {
    return (
      ...
      >
        ...
        <InfoItem label="Date of Birth" value="03/04/1998" />

        <InfoItem label="Gender" value="Male" />

        <InfoItem label="Joined" value="Jan 10" />

        <InfoItem label="Email" value="amerabdulai34@gmail.com" />

        <InfoItem
          label="Address"
          value="Dobri Doll Gostivar "
          withDivider={false}
        />
      </View>
    );
